...
class Model(nn.Module, ABC):
    ...
    def __init__(self, opt):
        ...
        self.cls_layer = nn.Linear(self.embedding_dim + 1 * node_embed_dim,self.embedding_dim)
    ...
    def forward(self,sentence,
        ...
        pool = torch.cat((pool_ans,prompt_ans),dim = 2) # [batch_size,class_num,embed_dim]
